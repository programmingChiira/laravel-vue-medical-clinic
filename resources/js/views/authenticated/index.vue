    ...
    <section class="about_section layout_margin-bottom">
      <div class="container  ">
        <div class="row">
          <div class="col-md-6 ">
            <div class="img-box">
              <img src="authenticated/images/about-img.jpg" alt="">
            </div>
          </div>
          <div class="col-md-6">
            <div class="detail-box">
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-sm-6 col-lg-4 mx-auto">
            <div class="box">
              <div class="img-box">
                <img src="authenticated/images/d1.jpg" alt="">
              </div>
              <div class="detail-box">
          ...
          <div class="col-sm-6 col-lg-4 mx-auto">
            <div class="box">
              <div class="img-box">
                <img src="authenticated/images/d2.jpg" alt="">
              </div>
              <div class="detail-box">
                <div class="social_box">
                  <a href="">
          ...
          <div class="col-sm-6 col-lg-4 mx-auto">
            <div class="box">
              <div class="img-box">
                <img src="authenticated/images/d3.jpg" alt="">
              </div>
              <div class="detail-box">
                <div class="social_box">
                  <a href="">
            ...
            <div class="carousel-item active">
              <div class="row">
                <div class="col-md-11 col-lg-10 mx-auto">
                  <div class="box">
                    <div class="img-box">
                      <img src="authenticated/images/client.jpg" alt="" />
                    </div>
                    <div class="detail-box">
                      <div class="name">
                        <h6>
                      ...
                      <p>
                        ...
                        nostrum
                        explicabo, distinctio laudantium delectus deserunt quia quidem magni corporis earum inventore
                        totam
