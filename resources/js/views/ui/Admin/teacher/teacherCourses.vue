                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>Institution courses</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                        ...
                        <div class="table-header">
                            <div class="d-flex align-items-center flex-column flex-sm-row flex-shrink-0">
                                <div class="mb-3 mb-sm-0 order-0 order-sm-1 mr-sm-2">
                                    <b-button variant="primary" class="ml-2" v-b-modal.institutionCoursesModalCenter>
                                ...
                                <b-modal id="institutionCoursesModalCenter" title="Create course" centered no-fade>
                                    <b-form @submit.prevent="submitInstitutionCourse">
                                        <b-form-row class="mb-4">
                                            <b-form-group label="Course" class="col-md-12">
                                                <b-input type="text" placeholder="Course e.g Physics, Geography"
                                                    v-model="fields.course"></b-input>
                                            </b-form-group>
                                        </b-form-row>
                                    ...
                                    <template #modal-footer>
                                        <b-button variant="default" data-dismiss="modal"
                                            @click="$bvModal.hide('institutionCoursesModalCenter')"><i class="flaticon-cancel-12"></i>
                                            Close</b-button>
                                    </template>
                                </b-modal>
                            </div>
                        ...
                        <b-table ref="basic_table" responsive hover :items="items" :fields="columns"
                            ...
                            <template #cell(course)="row">
                                <div class="d-flex">
                                    <div class="usr-img-frame mr-2 rounded-circle">
                                        <img :src="require('@/assets/images/' + row.item.thumb)"
                            ...
                            <template #cell(edit)="row">
                                <div class="position-relative">
                                    <router-link style="color: #2196f3;" :to="`/ui/editAdminInstitutionCourse/` + row.value">
...
export default {
    metaInfo: { title: 'Create institution course' },
    // metaInfo: {
    //     title() {
