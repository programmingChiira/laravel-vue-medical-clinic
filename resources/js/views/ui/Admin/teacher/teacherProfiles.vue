                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>registration</span>
                                </li>
                            </ol>
                        </nav>
                    </div>
            ...
            <div class="col-12 layout-spacing">
                <div class="panel br-6 ">
                    <div class="custom-table panel-body p-0">
                        ...
                        <b-modal id="modalxl" size="xl" title="Teacher registration" centered no-fade>
                            <div class="row">
                                <div id="flFormsGrid" class="col-lg-12 layout-spacing">
                                    <div class="box box-shadow">
                                        <div class="panel-body">
                                            <b-form @submit.prevent="submitTeacherRegistration">
                                                ...
                                                <b-form-row class="mb-4">
                                                    <b-form-group label="Teacher tsc no." class="col-md-6">
                                                        <b-input type="text" placeholder="Teacher tsc no."
                                                            v-model="teacher_tsc_no"></b-input>
                                                    </b-form-group>
                                                    <b-form-group label="Gender" class="col-md-6">
                                                        <b-select v-model="gender" size="sm">
                                                ...
                                                <div
                                                    v-show="institution_type == 'High school' || institution_type == 'Junior high school'">
                                                    <b-form-row class="mb-4">
                                                        <b-form-group label="Subjects" class="col-md-12">
                                                            <multiselect v-model="selectedCourses"
                                                                :options="selectCourseOptions" :multiple="true"
                                                                :taggable="true" :searchable="true" placeholder="Choose..."
                                                                selected-label="" select-label="" deselect-label=""
                                                                @tag="addCourseTag">
                                                            </multiselect>
                                                    ...
                                                    <b-form-row v-for="course in selectedCourses" :key="course"
                                                        class="mb-4">
                                                        <b-form-group :label="'Streams taught by ' + course + ' teacher'"
                                                            class="col-md-12">
                                                            <multiselect v-model="selectedClassYears[course]"
                                                                :options="generateFormStreamOptions(course)"
                                                                :multiple="true" :taggable="true" :searchable="true"
                                                                placeholder="Choose..." selected-label="" select-label=""
                                                                deselect-label="" @tag="addClassTag">
                                                            </multiselect>
                                                        </b-form-group>
                                                    </b-form-row>
                                                </div>

                                                <div v-show="institution_type == 'Primary school'">
                                                    <b-form-row class="mb-4">
                                                        <b-form-group label="Subjects" class="col-md-12">
                                                            <multiselect v-model="selectedCourses"
                                                                :options="selectCourseOptions" :multiple="true"
                                                    ...
                                                    <b-form-row v-for="course in selectedCourses" :key="course"
                                                        ...
                                                        <b-form-group :label="'Streams taught by ' + course + ' teacher'"
                                                            class="col-md-12">
                                                            <multiselect v-model="selectedClassYears[course]"
                                                                :options="generateClassStreamOptions(course)"
                                                                :multiple="true" :taggable="true" :searchable="true"
                                                                placeholder="Choose..." selected-label="" select-label=""
                                                                deselect-label="" @tag="addClassTag">
                                                            </multiselect>
                                                ...
                                                <div v-show="institution_type == 'Tertiary institution'">
                                                    <b-form-row class="mb-4">
                                                        <b-form-group label="Courses" class="col-md-12">
                                                            <multiselect v-model="selectedCourses"
                                                                :options="selectCourseOptions" :multiple="true"
                                                                :taggable="true" :searchable="true" placeholder="Choose..."
                                                                selected-label="" select-label="" deselect-label=""
                                                    ...
                                                    <b-form-row v-for="course in selectedCourses" :key="course"
                                                        class="mb-4">
                                                        <b-form-group
                                                            :label="'Academic year students taught by ' + course + ' lecturer'"
                                                            class="col-md-12">
                                                            <multiselect v-model="selectedClassYears[course]"
                                                                :options="selectClassOptions" :multiple="true"
                                                                :taggable="true" :searchable="true" placeholder="Choose..."
                                                                selected-label="" select-label="" deselect-label=""
                                                                @tag="addClassTag">
                                                            </multiselect>
                        ...
                        <b-table ref="basic_table" responsive hover :items="items" :fields="columns"
                            ...
                            <template #cell(user_account_status)="row">
                                <b-badge variant="success" class="inv-status">{{ row.value }}</b-badge>
                            </template>
                            ...
                            <template #cell(action)="row">
                                <b-button-group>
                                    <b-dropdown variant="dark" :right="true" toggle-tag="a" class="custom-dropdown">
                                        ...
                                        <b-dropdown-item>
                                            <router-link style="color: rgb(32, 190, 0);"
                                                :to="`/ui/viewadminTeacherProfile/` + row.item.view">
                                        ...
                                        <b-dropdown-item>
                                            <router-link style="color: #2196f3;"
                                                :to="`/ui/editadminTeacherProfile/` + row.item.edit">
                                                <svg style="width: 16px;" xmlns="http://www.w3.org/2000/svg" width="17"
                                                    height="17" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
                                        ...
                                        <b-dropdown-item>
                                            <button @click="deactivateUserAccount(row.item.delete)"
...
export default {
    ...
    methods: {
        ...
        fetchUsers(page) {
            axios
                .get('/api/activeTeacherList?page=' + page)
                .then((response) => {
        ...
        async deactivateUserAccount(userId) {
            ...
            swalWithBootstrapButtons
                ...
                .then(async (result) => { // Wrap the callback function in "async"
                    if (result.value) {
                        swalWithBootstrapButtons.fire('Deactivation successful!', 'Account has been deactivated.', 'success');
