                    ...
                    <div class="row">
                        <div
                            ...
                            <form class="form-inline my-2 my-lg-0">
                                <div class="">
                                    ...
                                    <b-input v-model.trim="search_user" class="product-search"
                                        v-on:keyup="search_contacts()" placeholder="Search..." />
                                </div>
                            </form>
                        </div>
                        ...
                        <div
                            ...
                            <div class="d-flex justify-content-sm-end justify-content-center">
                                ...
                                <div class="switch align-self-center">
                                    ...
                                    <a href="javascript:;" @click="grid_type = 'list'">
                                        <svg :class="{ 'active-view': grid_type == 'list' }"
                                            xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" class="feather feather-list view-list mr-1">
                                ...
                                <!-- Modal -->
                                <b-modal centered id="addContactModal" :static="true"
                                        ...
                                        <div class="add-contact-content">
                                            <b-form id="addContactModalTitle">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <b-input v-model="params.location"
                                                                placeholder="Location"></b-input>
                                                        </div>
                                                    </div>
                                                </div>
                                            </b-form>
                                    ...
                                    <template #modal-footer>
                                        <b-button variant="default" data-dismiss="modal"
                                            @click="$bvModal.hide('addContactModal')"><i class="flaticon-cancel-12"></i>
                                            Discard</b-button>
                                        <b-button variant="default" id="btn-add" @click="save_user()">{{ params.id ?
                                            'Update' : 'Add' }}</b-button>
                                    </template>
                                </b-modal>
                            </div>
                    ...
                    <div class="searchable-items" :class="[grid_type]">
                        <div class="items items-header-section">
                            <div class="item-content">
                                <div class="">
                                    <b-checkbox :checked="check_all_checkbox" variant="primary"
                                        class="checkbox-primary d-inline-block" @change="check_all($event)"></b-checkbox>
                                    <h4>Name</h4>
                                </div>
                                ...
                                <div class="action-btn">
                                    <a href="javascript:;" @click="delete_selected()" v-b-tooltip.hover
                        ...
                        <div v-for="(user, index) in filterd_contacts_list" class="items" :key="index">
                            <div class="item-content">
                                <div class="user-profile">
                                    <b-checkbox v-model="ids" variant="primary" class="checkbox-primary d-inline-block"
                                        :value="user.id"></b-checkbox>
                                ...
                                <div class="action-btn">
                                    <a href="javascript:;" class="mr-1" @click="edit_user(user)" v-b-tooltip.hover
                                        title="Edit">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
...
export default {
    ...
    methods: {
        ...
        // },
        search_contacts() {
            this.filterd_contacts_list = this.contacts_list.filter(contact => {
                const searchTerm = this.search_user.toLowerCase();
