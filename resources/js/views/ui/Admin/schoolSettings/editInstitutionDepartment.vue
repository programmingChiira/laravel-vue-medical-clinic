                ...
                <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <b-form @submit.prevent="updateDepartment" id="general-info"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    ...
                                                                    <b-input class="mb-4" id="department"
                                                                        placeholder="Department" v-model="fields.department">
                                                                    </b-input>
                                                                </div>
                                                            </div>
                                                        </div>
...
export default {
    metaInfo: { title: 'Edit department :- Intelligent system' },
    props: ["slug"],
    data() {
        return {
            fields: {},
    ...
    methods: {
        async updateDepartment() {
            ...
            try {
                const response = await axios.post(`/api/updateInstitutionDepartment/${this.fields.id}`, {
    ...
    mounted() {
        axios
            .get("/api/institutionDepartments/" + this.slug)
            .then((response) => {
