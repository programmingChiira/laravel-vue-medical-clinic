                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>edit extracurricular</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                ...
                <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <b-form @submit.prevent="updateExtracurricular" id="general-info"
                                                        ...
                                                        <div class="row">
                                                            <div class="col-sm-12">
                                                                <div class="form-group">
                                                                    <label for="class">Extracurricular</label>
                                                                    <b-input class="mb-4" id="extracurricular"
                                                                        placeholder="Extracurricular" v-model="fields.extracurricular">
                                                                    </b-input>
                                                                </div>
                                                            </div>
                                                        </div>
...
export default {
    metaInfo: { title: 'Edit extracurricular :- Intelligent system' },
    props: ["slug"],
    data() {
        return {
            fields: {},
    ...
    methods: {
        async updateExtracurricular() {
            ...
            try {
                const response = await axios.post(`/api/updateInstitutionExtracurricular/${this.fields.id}`, {
    ...
    mounted() {
        axios
            .get("/api/institutionExtracurriculars/" + this.slug)
            .then((response) => {
