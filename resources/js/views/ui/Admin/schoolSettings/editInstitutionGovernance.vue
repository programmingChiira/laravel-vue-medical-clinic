                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page"><span>edit governance</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                ...
                <div class="scrollspy-example" data-spy="scroll" data-target="#account-settings-scroll" data-offset="-100">
                    <div class="row">
                        <div class="col-xl-12 col-lg-12 col-md-12 layout-spacing">
                            <b-form @submit.prevent="updateGovernance" id="general-info"
                                                            ...
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <b-input class="mb-4" id="firstname"
                                                                        placeholder="First Name" v-model="fields.first_name">
                                                                    </b-input>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <b-input class="mb-4" id="middlename"
                                                                        placeholder="Middle Name" v-model="fields.middle_name">
                                                                    </b-input>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-4">
                                                                <div class="form-group">
                                                                    ...
                                                                    <b-input class="mb-4" id="lastname"
                                                                        placeholder="Last Name" v-model="fields.last_name">
                                                                    </b-input>
                                                                </div>
                                                            </div>
                                                        </div>
                                                            ...
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <b-input class="mb-4" id="phone"
                                                                        placeholder="Phone number" v-model="fields.phone_no">
                                                                    </b-input>
                                                                </div>
                                                            </div>
                                                            <div class="col-sm-6">
                                                                <div class="form-group">
                                                                    ...
                                                                    <b-input class="mb-4" id="email"
                                                                        placeholder="User email" v-model="fields.email">
                                                                    </b-input>
                                                                </div>
                                                            </div>
                                                        </div>
...
export default {
    metaInfo: { title: 'Edit governance :- Intelligent system' },
    props: ["slug"],
    data() {
        return {
            fields: {},
    ...
    methods: {
        async updateGovernance() {
            ...
            try {
                const response = await axios.post(`/api/updateInstitutionGovernance/${this.fields.id}`, {
                    firstName: this.fields.first_name,
                    secondName: this.fields.middle_name,
                    surName: this.fields.last_name,
                    mobileNumber: this.fields.phone_no,
    ...
    mounted() {
        axios
            .get("/api/institutionGovernances/" + this.slug)
            .then((response) => {
