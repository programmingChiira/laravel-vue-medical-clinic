                    ...
                    <div class="page-header">
                        <nav class="breadcrumb-one" aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li v-show="institution_type == 'High school'" class="breadcrumb-item active"
                                    aria-current="page"><span>forms</span></li>
                                <li v-show="institution_type == 'Junior high school'" class="breadcrumb-item active"
                                    aria-current="page"><span>forms</span></li>
                                <li v-show="institution_type == 'Primary school'" class="breadcrumb-item active"
                                    aria-current="page"><span>classes</span></li>
                                <li v-show="institution_type == 'Tertiary institution'" class="breadcrumb-item active"
                                    aria-current="page"><span>years</span></li>
                            </ol>
                        </nav>
                    </div>
                </li>
                        ...
                        <div class="table-header">
                            <div class="d-flex align-items-center flex-column flex-sm-row flex-shrink-0">
                                <div class="mb-3 mb-sm-0 order-0 order-sm-1 mr-sm-2">
                                    <b-button v-show="institution_type == 'High school'" variant="success" class="ml-2"
                                        v-b-modal.highSchoolModalCenter>
                                    ...
                                    <b-button v-show="institution_type == 'Junior high school'" variant="success"
                                        class="ml-2" v-b-modal.juniorHighSchoolModalCenter>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" class="feather feather-plus">
                                            <line x1="12" y1="5" x2="12" y2="19"></line>
                                    ...
                                    <b-button v-show="institution_type == 'Primary school'" variant="success" class="ml-2"
                                        v-b-modal.primarySchoolModalCenter>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" class="feather feather-plus">
                                            <line x1="12" y1="5" x2="12" y2="19"></line>
                                    ...
                                    <b-button v-show="institution_type == 'Tertiary institution'" variant="success"
                                        class="ml-2" v-b-modal.tertiaryInstitutionModalCenter>
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                            fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round"
                                            stroke-linejoin="round" class="feather feather-plus">
                                            <line x1="12" y1="5" x2="12" y2="19"></line>
                                ...
                                <b-modal v-show="institution_type == 'High school'" id="highSchoolModalCenter"
                                    title="Create form" centered no-fade>
                                    <b-form @submit.prevent="submitInstitutionClass">
                                        <b-form-row class="mb-4">
                                            <b-form-group label="Form" class="col-md-12">
                                                <b-input type="text" placeholder="Form e.g 1, 2, 3"
                                                    v-model="fields.class"></b-input>
                                            </b-form-group>
                                        </b-form-row>
                                    ...
                                    <template #modal-footer>
                                        <b-button variant="default" data-dismiss="modal"
                                            @click="$bvModal.hide('highSchoolModalCenter')"><i
                                                class="flaticon-cancel-12"></i>
                                            Close</b-button>
                                    </template>
                                </b-modal>

                                <b-modal v-show="institution_type == 'Junior high school'" id="juniorHighSchoolModalCenter"
                                    title="Create form" centered no-fade>
                                    <b-form @submit.prevent="submitInstitutionClass">
                                        <b-form-row class="mb-4">
                                            <b-form-group label="Form" class="col-md-12">
                                    ...
                                    <template #modal-footer>
                                        <b-button variant="default" data-dismiss="modal"
                                            @click="$bvModal.hide('juniorHighSchoolModalCenter')"><i
                                                class="flaticon-cancel-12"></i>
                                            Close</b-button>
                                    </template>
                                </b-modal>

                                <b-modal v-show="institution_type == 'Primary school'" id="primarySchoolModalCenter"
                                    title="Create class" centered no-fade>
                                    <b-form @submit.prevent="submitInstitutionClass">
                                        <b-form-row class="mb-4">
                                            <b-form-group label="Class" class="col-md-12">
                                                <b-input type="text" placeholder="Class e.g 1, 2, 3"
                                                    v-model="fields.class"></b-input>
                                            </b-form-group>
                                        </b-form-row>
                                    ...
                                    <template #modal-footer>
                                        <b-button variant="default" data-dismiss="modal"
                                            @click="$bvModal.hide('primarySchoolModalCenter')"><i
                                                class="flaticon-cancel-12"></i>
                                            Close</b-button>
                                    </template>
                                </b-modal>

                                <b-modal v-show="institution_type == 'Tertiary institution'"
                                    id="tertiaryInstitutionModalCenter" title="Create academic year" centered no-fade>
                                    <b-form @submit.prevent="submitInstitutionClass">
                                        <b-form-row class="mb-4">
                                            <b-form-group label="Academic year" class="col-md-12">
                                                <b-input type="text" placeholder="Academic year e.g 1, 2, 3"
                                                    v-model="fields.class"></b-input>
                                            </b-form-group>
                                        </b-form-row>
                                    ...
                                    <template #modal-footer>
                                        <b-button variant="default" data-dismiss="modal"
                                            @click="$bvModal.hide('tertiaryInstitutionModalCenter')"><i
                                                class="flaticon-cancel-12"></i>
                                            Close</b-button>
                                    </template>
                                </b-modal>
                        ...
                        <b-table ref="basic_table" responsive hover :items="items" :fields="columns"
                            ...
                            <template #cell(edit)="row">
                                <div class="position-relative">
                                    <router-link style="color: #2196f3;" :to="`/ui/editAdminInstitutionClass/` + row.value">
...
export default {
    metaInfo: { title: 'Institution Ranks :- Intelligent system' },
    ...
    created() {
        this.institutionClass(this.currentPage);
    },
    ...
    methods: {
        ...
        institutionClass(page) {
            axios
                .get('/api/institutionClasses?page=' + page)
                .then((response) => {
                    this.class = response.data.data;
                    this.currentPage = response.data.current_page;
                    this.lastPage = response.data.last_page;

                    this.items = this.class.map((classData) => {
                        return {
                            id: classData.id,
        ...
        fetchData(page = 1) {
            axios
                .get(`/api/institutionClasses?page=${page}`)
                .then((response) => {
                    this.items = response.data.data.map((classData) => {
                        return {
                            id: classData.id,
                            class: classData.class,
                            edit: classData.slug,
        ...
        async submitInstitutionClass() {
            this.isSubmitting = true;

            try {
                const response = await axios.post("/api/adminInstitutionClass", {
        ...
        bind_data() {
            ...
            this.items = this.class.map((item, index) => {
                return {
                    id: index + 1,
                    class: item.class,
                    edit: item.slug,
        ...
        edit_row(item) {
            this.$router.push(`/ui/editAdminInstitutionClass/${item.slug}`);
        },
            ...
            swalWithBootstrapButtons
                ...
                .then(result => {
                    if (result.value) {
                        ...
                        axios
                            .delete("/api/deleteInstitutionClass/" + id)
                            .then((response) => {
                                this.fetchData();
                            }).catch((error) => {
